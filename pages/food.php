...
<div class="container p-4 ">
    ...
    <div class="d-flex  bg-light shadow ">
        ...
        <img class="border border-light " width="60%" height="auto" src="https://english.mathrubhumi.com/polopoly_fs/1.4351190.1575946459!/image/image.jpg_gen/derivatives/landscape_1080_600/image.jpg" alt="">
    </div>
    <br>
    <hr>
    ...
    <div class="row mt-4">
        <?php
            ...
            $description = readMore($food['description'], 100);
        ...
        <div class="col-4">
            <div class="shadow rounded mb-4">
                ...
                <p><?= $description ?>...<a href="read_more/detail.php?id= <?= $food['product_id'] ?>" class="btn btn-light btn-sm text-primary">Readmore</a></p> 
                
        
                <div class="action d-flex justify-content-end">
                    <a href="process_product/update_product_html.php?id=<?= $food['product_id'] ?>&page=<?= $_GET['page'] ?>" class="btn btn-primary btn-sm mr-2"><i class="fa fa-pencil"></i></a>
                    <a href="process_product/delete_product.php?id=<?= $food['product_id'] ?>&page=<?= $_GET['page'] ?>" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                </div> 
                <div class="mt-2">
                    <span class="btn btn-success btn-sm text-center form-control" >Price: <?= $food['price'] ?>$</span>
                </div>
