                    ...
                    <form action="update_user_model.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="">
                            <div class="form-group"> 
                                <input type="text" class="form-control" placeholder="Username" name="user" value="<?= $user['username'] ?>">    
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <button type="submit" class="btn btn-primary btn-block ">Updatee</button>
                            </div>
                        </div>
                    </form>
                    <?php endforeach;?>
