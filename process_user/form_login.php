...
<div class="container p-4">
    <div class="row d-flex justify-content-center">
        <div class="col-sm-6">
                    ...
                    <?php 
                        ...
                        <div class="">
                            ...
                            <div class="form-group">
                                ...
                                <?php if($Islogin=='valid'):?>
                                <p class="text-success">Login success! you can click button GO</p>
                                <?php endif ; ?>
                                <?php if($Islogin=='not valid'):?>
                                <p class="text-danger">username and password not valid</p>
                                <?php endif ; ?>
                            </div>
            ...
            <div class="d-flex justify-content-center ">
                <?php if($Islogin!='valid'):?>
                <button class="btn btn-info btn-block" onclick="window.history.back();">&#8592; Back</button>
                <?php endif; ?>
                <?php if($Islogin=='valid'):?>
                    
                    <a href="http://localhost:8080/php/2021-php-project-sinetsem/?page=home" class="btn btn-success btn-block">GO</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
